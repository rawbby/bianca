...
llama.llama_model_init_from_user.argtypes = [ctypes.POINTER(GgufContext), ctypes.c_void_p, ctypes.c_void_p, LlamaModelParams]
...
llama.llama_adapter_meta_key_by_index.argtypes = [LlamaAdapterLoraPointer, ctypes.c_int32, ctypes.c_char_p, ctypes.c_size_t]
llama.llama_adapter_meta_key_by_index.restype = ctypes.c_int32

llama.llama_adapter_meta_val_str_by_index.argtypes = [LlamaAdapterLoraPointer, ctypes.c_int32, ctypes.c_char_p, ctypes.c_size_t]
...
llama.llama_set_adapters_lora.argtypes = [LlamaContextPointer, ctypes.POINTER(LlamaAdapterLoraPointer), ctypes.c_size_t, ctypes.POINTER(ctypes.c_float)]
llama.llama_set_adapters_lora.restype = ctypes.c_int32

llama.llama_set_adapter_cvec.argtypes = [LlamaContextPointer, ctypes.POINTER(ctypes.c_float), ctypes.c_size_t, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32]
...
llama.llama_memory_seq_cp.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
...
llama.llama_memory_seq_add.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
...
llama.llama_state_load_file.argtypes = [LlamaContextPointer, ctypes.c_char_p, LlamaTokenPointer, ctypes.c_size_t, ctypes.POINTER(ctypes.c_size_t)]
llama.llama_state_load_file.restype = ctypes.c_int

llama.llama_load_session_file.argtypes = [LlamaContextPointer, ctypes.c_char_p, LlamaTokenPointer, ctypes.c_size_t, ctypes.POINTER(ctypes.c_size_t)]
...
llama.llama_state_seq_get_data.argtypes = [LlamaContextPointer, ctypes.POINTER(ctypes.c_uint8), ctypes.c_size_t, ctypes.c_void_p]
llama.llama_state_seq_get_data.restype = ctypes.c_int

llama.llama_state_seq_set_data.argtypes = [LlamaContextPointer, ctypes.POINTER(ctypes.c_uint8), ctypes.c_size_t, ctypes.c_void_p]
llama.llama_state_seq_set_data.restype = ctypes.c_int

llama.llama_state_seq_save_file.argtypes = [LlamaContextPointer, ctypes.c_char_p, ctypes.c_void_p, LlamaTokenPointer, ctypes.c_size_t]
llama.llama_state_seq_save_file.restype = ctypes.c_int

llama.llama_state_seq_load_file.argtypes = [LlamaContextPointer, ctypes.c_char_p, ctypes.c_void_p, LlamaTokenPointer, ctypes.c_size_t, ctypes.POINTER(ctypes.c_size_t)]
...
llama.llama_state_seq_get_data_ext.argtypes = [LlamaContextPointer, ctypes.POINTER(ctypes.c_uint8), ctypes.c_size_t, ctypes.c_void_p, ctypes.c_void_p]
llama.llama_state_seq_get_data_ext.restype = ctypes.c_int

llama.llama_state_seq_set_data_ext.argtypes = [LlamaContextPointer, ctypes.POINTER(ctypes.c_uint8), ctypes.c_size_t, ctypes.c_void_p, ctypes.c_void_p]
...
llama.llama_tokenize.argtypes = [LlamaVocabPointer, ctypes.c_char_p, ctypes.c_int32, LlamaTokenPointer, ctypes.c_int32, ctypes.c_bool, ctypes.c_bool]
llama.llama_tokenize.restype = ctypes.c_int32

llama.llama_token_to_piece.argtypes = [LlamaVocabPointer, ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int32, ctypes.c_int32, ctypes.c_bool]
llama.llama_token_to_piece.restype = ctypes.c_int32

llama.llama_detokenize.argtypes = [LlamaVocabPointer, LlamaTokenPointer, ctypes.c_int32, ctypes.c_char_p, ctypes.c_int32, ctypes.c_bool, ctypes.c_bool]
llama.llama_detokenize.restype = ctypes.c_int32

llama.llama_chat_apply_template.argtypes = [ctypes.c_char_p, LlamaChatMessagePointer, ctypes.c_size_t, ctypes.c_bool, ctypes.c_char_p, ctypes.c_int32]
...
llama.llama_sampler_init_mirostat.argtypes = [ctypes.c_int32, ctypes.c_uint32, ctypes.c_float, ctypes.c_float, ctypes.c_int32]
...
llama.llama_sampler_init_grammar_lazy.argtypes = [LlamaVocabPointer, ctypes.c_char_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_char_p), ctypes.c_size_t, LlamaTokenPointer, ctypes.c_size_t]
llama.llama_sampler_init_grammar_lazy.restype = LlamaSamplerPointer

llama.llama_sampler_init_grammar_lazy_patterns.argtypes = [LlamaVocabPointer, ctypes.c_char_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_char_p), ctypes.c_size_t, LlamaTokenPointer, ctypes.c_size_t]
...
llama.llama_sampler_init_dry.argtypes = [LlamaVocabPointer, ctypes.c_int32, ctypes.c_float, ctypes.c_float, ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char_p), ctypes.c_size_t]
...
llama.llama_opt_epoch.argtypes = [LlamaContextPointer, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int64, ctypes.c_void_p, ctypes.c_void_p]
llama.llama_opt_epoch.restype = None

class PyGgmlTensor:
    def __init__(self, type=None, buffer=None, ne=None, nb=None, op=None, op_params=None, flags=None, src=None, view_src=None, view_offs=None, data=None, name=None, extra=None, padding=None):
        self.type = type
        self.buffer = buffer
        self.ne = ne
        self.nb = nb
...
class PyLlamaModelParams:
    def __init__(self, devices=None, tensor_buft_overrides=None, n_gpu_layers=None, split_mode=None, main_gpu=None, tensor_split=None, progress_callback=None, progress_callback_user_data=None, kv_overrides=None, vocab_only=None, use_mmap=None, use_direct_io=None, use_mlock=None, check_tensors=None, use_extra_bufts=None, no_host=None, no_alloc=None):
...
class PyLlamaContextParams:
    def __init__(self, n_ctx=None, n_batch=None, n_ubatch=None, n_seq_max=None, n_rs_seq=None, n_outputs_max=None, n_threads=None, n_threads_batch=None, ctx_type=None, rope_scaling_type=None, pooling_type=None, attention_type=None, flash_attn_type=None, rope_freq_base=None, rope_freq_scale=None, yarn_ext_factor=None, yarn_attn_factor=None, yarn_beta_fast=None, yarn_beta_slow=None, yarn_orig_ctx=None, defrag_thold=None, cb_eval=None, cb_eval_user_data=None, type_k=None, type_v=None, abort_callback=None, abort_callback_data=None, embeddings=None, offload_kqv=None, no_perf=None, op_offload=None, swa_full=None, kv_unified=None, samplers=None, n_samplers=None, ctx_other=None):
        self.n_ctx = n_ctx
...
class PyLlamaModelQuantizeParams:
    def __init__(self, nthread=None, ftype=None, output_tensor_type=None, token_embedding_type=None, allow_requantize=None, quantize_output_tensor=None, only_copy=None, pure=None, keep_split=None, dry_run=None, imatrix=None, kv_overrides=None, tt_overrides=None, prune_layers=None):
...
class PyLlamaSamplerI:
    def __init__(self, name=None, accept=None, apply=None, reset=None, clone=None, free=None, backend_init=None, backend_accept=None, backend_apply=None, backend_set_input=None):
        self.name = name
        self.accept = accept
        self.apply = apply
        self.reset = reset
...
class PyLlamaPerfContextData:
    def __init__(self, t_start_ms=None, t_load_ms=None, t_p_eval_ms=None, t_eval_ms=None, n_p_eval=None, n_eval=None, n_reused=None):
...
class PyLlamaOptParams:
    def __init__(self, n_ctx_train=None, param_filter=None, param_filter_ud=None, get_opt_pars=None, get_opt_pars_ud=None, optimizer_type=None):
...
def c_llama_model_init_from_user(metadata, set_tensor_data, set_tensor_data_ud, params: 'LlamaModelParams') -> 'LlamaModelPointer':
    return llama.llama_model_init_from_user(metadata, set_tensor_data, set_tensor_data_ud, params)

def llama_model_init_from_user(metadata, set_tensor_data, set_tensor_data_ud, params: 'PyLlamaModelParams') -> 'LlamaModelPointer':
...
def c_llama_set_adapter_cvec(ctx: 'LlamaContextPointer', data, len_: int, n_embd: int, il_start: int, il_end: int) -> int:
...
def c_llama_state_load_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens_out: 'LlamaTokenPointer', n_token_capacity: int, n_token_count_out) -> int:
    return llama.llama_state_load_file(ctx, path_session, tokens_out, n_token_capacity, n_token_count_out)

def llama_state_load_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens_out: 'LlamaTokenPointer', n_token_capacity: int, n_token_count_out) -> int:
    return c_llama_state_load_file(ctx, path_session, tokens_out, n_token_capacity, n_token_count_out)
def c_llama_load_session_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens_out: 'LlamaTokenPointer', n_token_capacity: int, n_token_count_out) -> int:
    return llama.llama_load_session_file(ctx, path_session, tokens_out, n_token_capacity, n_token_count_out)

def llama_load_session_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens_out: 'LlamaTokenPointer', n_token_capacity: int, n_token_count_out) -> int:
    return c_llama_load_session_file(ctx, path_session, tokens_out, n_token_capacity, n_token_count_out)
def c_llama_state_save_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens: 'LlamaTokenPointer', n_token_count: int) -> int:
    return llama.llama_state_save_file(ctx, path_session, tokens, n_token_count)

def llama_state_save_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens: 'LlamaTokenPointer', n_token_count: int) -> int:
    return c_llama_state_save_file(ctx, path_session, tokens, n_token_count)
def c_llama_save_session_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens: 'LlamaTokenPointer', n_token_count: int) -> int:
    return llama.llama_save_session_file(ctx, path_session, tokens, n_token_count)

def llama_save_session_file(ctx: 'LlamaContextPointer', path_session: bytes, tokens: 'LlamaTokenPointer', n_token_count: int) -> int:
...
def c_llama_state_seq_save_file(ctx: 'LlamaContextPointer', filepath: bytes, seq_id, tokens: 'LlamaTokenPointer', n_token_count: int) -> int:
    return llama.llama_state_seq_save_file(ctx, filepath, seq_id, tokens, n_token_count)

def llama_state_seq_save_file(ctx: 'LlamaContextPointer', filepath: bytes, seq_id, tokens: 'LlamaTokenPointer', n_token_count: int) -> int:
    return c_llama_state_seq_save_file(ctx, filepath, seq_id, tokens, n_token_count)
def c_llama_state_seq_load_file(ctx: 'LlamaContextPointer', filepath: bytes, dest_seq_id, tokens_out: 'LlamaTokenPointer', n_token_capacity: int, n_token_count_out) -> int:
    return llama.llama_state_seq_load_file(ctx, filepath, dest_seq_id, tokens_out, n_token_capacity, n_token_count_out)

def llama_state_seq_load_file(ctx: 'LlamaContextPointer', filepath: bytes, dest_seq_id, tokens_out: 'LlamaTokenPointer', n_token_capacity: int, n_token_count_out) -> int:
...
def c_llama_tokenize(vocab: 'LlamaVocabPointer', text: bytes, text_len: int, tokens: 'LlamaTokenPointer', n_tokens_max: int, add_special: bool, parse_special: bool) -> int:
    return llama.llama_tokenize(vocab, text, text_len, tokens, n_tokens_max, add_special, parse_special)

def llama_tokenize(vocab: 'LlamaVocabPointer', text: bytes, text_len: int, tokens: 'LlamaTokenPointer', n_tokens_max: int, add_special: bool, parse_special: bool) -> int:
    return c_llama_tokenize(vocab, text, text_len, tokens, n_tokens_max, add_special, parse_special)
def c_llama_token_to_piece(vocab: 'LlamaVocabPointer', token, buf: bytes, length: int, lstrip: int, special: bool) -> int:
...
def c_llama_detokenize(vocab: 'LlamaVocabPointer', tokens: 'LlamaTokenPointer', n_tokens: int, text: bytes, text_len_max: int, remove_special: bool, unparse_special: bool) -> int:
    return llama.llama_detokenize(vocab, tokens, n_tokens, text, text_len_max, remove_special, unparse_special)

def llama_detokenize(vocab: 'LlamaVocabPointer', tokens: 'LlamaTokenPointer', n_tokens: int, text: bytes, text_len_max: int, remove_special: bool, unparse_special: bool) -> int:
    return c_llama_detokenize(vocab, tokens, n_tokens, text, text_len_max, remove_special, unparse_special)
def c_llama_chat_apply_template(tmpl: bytes, chat: 'LlamaChatMessagePointer', n_msg: int, add_ass: bool, buf: bytes, length: int) -> int:
    return llama.llama_chat_apply_template(tmpl, chat, n_msg, add_ass, buf, length)

def llama_chat_apply_template(tmpl: bytes, chat: 'LlamaChatMessagePointer', n_msg: int, add_ass: bool, buf: bytes, length: int) -> int:
...
def c_llama_sampler_init_grammar(vocab: 'LlamaVocabPointer', grammar_str: bytes, grammar_root: bytes) -> 'LlamaSamplerPointer':
    return llama.llama_sampler_init_grammar(vocab, grammar_str, grammar_root)

def llama_sampler_init_grammar(vocab: 'LlamaVocabPointer', grammar_str: bytes, grammar_root: bytes) -> 'LlamaSamplerPointer':
    return c_llama_sampler_init_grammar(vocab, grammar_str, grammar_root)
def c_llama_sampler_init_grammar_lazy(vocab: 'LlamaVocabPointer', grammar_str: bytes, grammar_root: bytes, trigger_words, num_trigger_words: int, trigger_tokens: 'LlamaTokenPointer', num_trigger_tokens: int) -> 'LlamaSamplerPointer':
    return llama.llama_sampler_init_grammar_lazy(vocab, grammar_str, grammar_root, trigger_words, num_trigger_words, trigger_tokens, num_trigger_tokens)

def llama_sampler_init_grammar_lazy(vocab: 'LlamaVocabPointer', grammar_str: bytes, grammar_root: bytes, trigger_words, num_trigger_words: int, trigger_tokens: 'LlamaTokenPointer', num_trigger_tokens: int) -> 'LlamaSamplerPointer':
    return c_llama_sampler_init_grammar_lazy(vocab, grammar_str, grammar_root, trigger_words, num_trigger_words, trigger_tokens, num_trigger_tokens)
def c_llama_sampler_init_grammar_lazy_patterns(vocab: 'LlamaVocabPointer', grammar_str: bytes, grammar_root: bytes, trigger_patterns, num_trigger_patterns: int, trigger_tokens: 'LlamaTokenPointer', num_trigger_tokens: int) -> 'LlamaSamplerPointer':
    return llama.llama_sampler_init_grammar_lazy_patterns(vocab, grammar_str, grammar_root, trigger_patterns, num_trigger_patterns, trigger_tokens, num_trigger_tokens)

def llama_sampler_init_grammar_lazy_patterns(vocab: 'LlamaVocabPointer', grammar_str: bytes, grammar_root: bytes, trigger_patterns, num_trigger_patterns: int, trigger_tokens: 'LlamaTokenPointer', num_trigger_tokens: int) -> 'LlamaSamplerPointer':
    return c_llama_sampler_init_grammar_lazy_patterns(vocab, grammar_str, grammar_root, trigger_patterns, num_trigger_patterns, trigger_tokens, num_trigger_tokens)
def c_llama_sampler_init_penalties(penalty_last_n: int, penalty_repeat: float, penalty_freq: float, penalty_present: float) -> 'LlamaSamplerPointer':
    return llama.llama_sampler_init_penalties(penalty_last_n, penalty_repeat, penalty_freq, penalty_present)

def llama_sampler_init_penalties(penalty_last_n: int, penalty_repeat: float, penalty_freq: float, penalty_present: float) -> 'LlamaSamplerPointer':
    return c_llama_sampler_init_penalties(penalty_last_n, penalty_repeat, penalty_freq, penalty_present)
def c_llama_sampler_init_dry(vocab: 'LlamaVocabPointer', n_ctx_train: int, dry_multiplier: float, dry_base: float, dry_allowed_length: int, dry_penalty_last_n: int, seq_breakers, num_breakers: int) -> 'LlamaSamplerPointer':
    return llama.llama_sampler_init_dry(vocab, n_ctx_train, dry_multiplier, dry_base, dry_allowed_length, dry_penalty_last_n, seq_breakers, num_breakers)

def llama_sampler_init_dry(vocab: 'LlamaVocabPointer', n_ctx_train: int, dry_multiplier: float, dry_base: float, dry_allowed_length: int, dry_penalty_last_n: int, seq_breakers, num_breakers: int) -> 'LlamaSamplerPointer':
    return c_llama_sampler_init_dry(vocab, n_ctx_train, dry_multiplier, dry_base, dry_allowed_length, dry_penalty_last_n, seq_breakers, num_breakers)
...
def c_llama_sampler_init_logit_bias(n_vocab: int, n_logit_bias: int, logit_bias: 'LlamaLogitBiasPointer') -> 'LlamaSamplerPointer':
    return llama.llama_sampler_init_logit_bias(n_vocab, n_logit_bias, logit_bias)

def llama_sampler_init_logit_bias(n_vocab: int, n_logit_bias: int, logit_bias: 'LlamaLogitBiasPointer') -> 'LlamaSamplerPointer':
...
def c_llama_opt_epoch(lctx: 'LlamaContextPointer', dataset, result_train, result_eval, idata_split: int, callback_train, callback_eval):
    return llama.llama_opt_epoch(lctx, dataset, result_train, result_eval, idata_split, callback_train, callback_eval)

def llama_opt_epoch(lctx: 'LlamaContextPointer', dataset, result_train, result_eval, idata_split: int, callback_train, callback_eval):
